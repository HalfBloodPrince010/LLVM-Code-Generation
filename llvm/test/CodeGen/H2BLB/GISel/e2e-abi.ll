...
; RUN: llc -mtriple h2blb--darwin -o - %s -global-isel=1 -global-isel-abort=1 -verify-machineinstrs -enable-misched=false | FileCheck %s
...
; CHECK-NEXT:    ldrsp32 d2, sp, 8
; CHECK-NEXT:    addi32 d1, d1, d2
; CHECK-NEXT:    ldrsp32 d2, sp, 0 # 4-byte Folded Reload
; CHECK-NEXT:    addsp sp, sp, 4
; CHECK-NEXT:    ret
  %sum = add i32 %x, %y
...
; CHECK-NEXT:    strsp16 r1, sp, 32 # 2-byte Folded Spill
; CHECK-NEXT:    strsp16 r2, sp, 38 # 2-byte Folded Spill
; CHECK-NEXT:    strsp16 r3, sp, 36 # 2-byte Folded Spill
; CHECK-NEXT:    ldrsp16 r7, sp, 48
; CHECK-NEXT:    strsp16 r7, sp, 28 # 2-byte Folded Spill
; CHECK-NEXT:    ldrsp16 r1, sp, 50
; CHECK-NEXT:    strsp16 r1, sp, 26 # 2-byte Folded Spill
; CHECK-NEXT:    ldrsp16 r3, sp, 52
; CHECK-NEXT:    strsp16 r3, sp, 20 # 2-byte Folded Spill
; CHECK-NEXT:    ldrsp16 r4, sp, 54
; CHECK-NEXT:    ldrsp16 r5, sp, 56
; CHECK-NEXT:    ldrsp16 r0, sp, 58
; CHECK-NEXT:    strsp16 r0, sp, 30 # 2-byte Folded Spill
; CHECK-NEXT:    ldrsp16 r6, sp, 60
; CHECK-NEXT:    ldrsp16 r2, sp, 62
; CHECK-NEXT:    strsp16 r2, sp, 22 # 2-byte Folded Spill
; CHECK-NEXT:    strsp16 r7, sp, 0
; CHECK-NEXT:    strsp16 r1, sp, 2
; CHECK-NEXT:    strsp16 r3, sp, 4
; CHECK-NEXT:    strsp16 r4, sp, 6
; CHECK-NEXT:    strsp16 r5, sp, 8
; CHECK-NEXT:    strsp16 r0, sp, 10
; CHECK-NEXT:    strsp16 r6, sp, 12
; CHECK-NEXT:    strsp16 r2, sp, 14
; CHECK-NEXT:    ldrsp16 r7, sp, 32 # 2-byte Folded Reload
; CHECK-NEXT:    mov16 r1, r7
; CHECK-NEXT:    ldrsp16 r2, sp, 38 # 2-byte Folded Reload
; CHECK-NEXT:    ldrsp16 r3, sp, 36 # 2-byte Folded Reload
; CHECK-NEXT:    call lotsOfArgs2
; CHECK-NEXT:    strsp16 r1, sp, 24 # 2-byte Folded Spill
; CHECK-NEXT:    strsp16 r5, sp, 0
; CHECK-NEXT:    strsp16 r4, sp, 2
; CHECK-NEXT:    ldrsp16 r0, sp, 20 # 2-byte Folded Reload
; CHECK-NEXT:    strsp16 r0, sp, 4
...
; CHECK-NEXT:    ldrsp16 r0, sp, 36 # 2-byte Folded Reload
; CHECK-NEXT:    strsp16 r0, sp, 10
; CHECK-NEXT:    ldrsp16 r0, sp, 38 # 2-byte Folded Reload
; CHECK-NEXT:    strsp16 r0, sp, 12
; CHECK-NEXT:    strsp16 r7, sp, 14
; CHECK-NEXT:    ldrsp16 r1, sp, 22 # 2-byte Folded Reload
; CHECK-NEXT:    mov16 r2, r6
; CHECK-NEXT:    ldrsp16 r3, sp, 30 # 2-byte Folded Reload
; CHECK-NEXT:    call lotsOfArgs2
; CHECK-NEXT:    ldrsp16 r0, sp, 24 # 2-byte Folded Reload
; CHECK-NEXT:    addi16 r0, r7, r0
; CHECK-NEXT:    addi16 r0, r6, r0
; CHECK-NEXT:    addi16 r1, r0, r1
; CHECK-NEXT:    ldrsp16 r0, sp, 34 # 2-byte Folded Reload
